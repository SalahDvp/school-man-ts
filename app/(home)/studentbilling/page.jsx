...
import PaymentForm from "./components/StudentPaymentform"
import { useState } from "react"
import SheetDemo from "./components/editTeacherPayment"
import { Overview } from "./components/area-chart"
import Graph from "./components/graph"
import{ DataTableDemoStudent }from  "./components/tableStudent"
 ...
 function Dashboard() {
  ...
  return (
    ...
    <div className="flex flex-row min-h-screen w-full flex-col bg-muted/40">
      ...
      <CardDescription>Studets Payments</CardDescription>
                  <Overview/>
